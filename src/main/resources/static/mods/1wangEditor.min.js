!function (e, t) {
    ...
    function T(e) {
        ...
        return (e.childNodes() || []).forEach(function (e) {
            ...
            if (3 === i && (n = e.textContent), 1 === i) {
                n = {}, n.tag = e.nodeName.toLowerCase();
                for (var A = [], r = e.attributes || {}, c = r.length || 0, a = 0; a < c; a++) {
                    var s = r[a];
                    A.push({name: s.name, value: s.value})
                }
                n.attrs = A, n.children = T(o(e))
            }
            t.push(n)
        }), t
    }
            ...
            if (e && e.length) {
                ...
                if (w || o || c) {
                    ...
                    if (r(e, function (e) {
                        ...
                        if (t && n) return !1 === /\.(jpg|jpeg|png|bmp|gif)$/i.test(t) ? void E.push("【" + t + "】不是图片") : a < n ? void E.push("【" + t + "】大于 " + s + "M") : void v.push(e)
                    ...
                    if (r(v, function (e) {
                        ...
                        var y = B[1] || "";
                        A(u, function (e, t) {
                            t = encodeURIComponent(t), h && (o.indexOf("?") > 0 ? o += "&" : o += "?", o = o + e + "=" + t), b.append(e, t)
                        }), y && (o += "#" + y);
