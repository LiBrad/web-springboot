...
public class OnlineLearningBean {
    @TableId(value = "ID")
    private String id;
    ...
    public String getTechnicalInformationTypeName() {
        return technicalInformationTypeName;
    }

    public void setTechnicalInformationTypeName(String technicalInformationTypeName) {
        this.technicalInformationTypeName = technicalInformationTypeName;
    }
